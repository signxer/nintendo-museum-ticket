        ...
        <table className="w-full text-left text-sm border-collapse">
          <thead>
            <tr className="border-b-4 border-nintendo-grey">
              ...
              <th className="py-2 pr-3 font-pixel text-nintendo-grey whitespace-nowrap">{t('home.lotteryEntry')}</th>
              <th className="py-2 pr-3 font-pixel text-nintendo-grey whitespace-nowrap">{t('home.lotteryResult')}</th>
              <th className="py-2 font-pixel text-nintendo-grey whitespace-nowrap">{t('home.firstCome')}</th>
            </tr>
          </thead>
          <tbody>
            {rows.map((row) => (
              ...
              >
                ...
                <td className="py-2 font-pixel text-nintendo-red whitespace-nowrap">{formatDateTime(row.firstCome)}</td>
              </tr>
            ))}
          </tbody>
        </table>
